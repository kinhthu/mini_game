(function() {
    ...
    window.MemoryGame = {
        init: function() {
            ...
            if (playAgainBtn) playAgainBtn.addEventListener('click', onPlayAgainBtnClick);
            if (nextLevelBtn) nextLevelBtn.addEventListener('click', onNextLevelBtnClick);
        ...
        stop: function() {
            ...
            if (restartBtn) restartBtn.removeEventListener('click', onRestartBtnClick);
            if (playAgainBtn) playAgainBtn.removeEventListener('click', onPlayAgainBtnClick);
            if (nextLevelBtn) nextLevelBtn.removeEventListener('click', onNextLevelBtnClick);

...
2. **Act**: chạy build + test suite (Bash). Bổ sung test còn thiếu (ưu tiên kịch bản BDD/Gherkin rõ ràng khi phù hợp). Chỉ thêm/sửa **code test**, không sửa code sản phẩm.
